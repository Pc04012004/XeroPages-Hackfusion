      ...
      <div className="min-h-screen bg-gray-100 p-8">
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <button
              onClick={handleVote}
              className="mt-4 bg-green-600 text-white px-6 py-2 rounded-full w-full hover:bg-blue-700 transition-colors duration-300"
            >
              Approve Candidate
            </button>
          </motion.div>
