              ...
              <table className="w-full text-sm text-gray-700">
                <thead>
                  <tr className="border-b">
                    ...
                    <th className="py-3 font-medium text-left">HOD Approval</th>
                    <th className="py-3 font-medium text-left">Warden Approval</th>
                    <th className="py-3 font-medium text-left">Security Verification</th>
                    <th className="py-3 font-medium text-left">Final Status</th>
...
export default WardenDashboard; // Updated export statement